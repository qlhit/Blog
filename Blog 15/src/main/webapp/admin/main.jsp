...
<title>博客系统后台管理页面-Powered by 七弦僧</title>
...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="Blog'logo" src="/static/images/logob.png">
			</td>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10">Welcome Back Mr.Qi</font></div>
		</div>
	</div>
</div>
