...
<script type="text/javascript">
	...
	function formatTitle(val,row){
	    return "<a target='_blank' style='text-decoration: none;' href='${pageContext.request.contextPath}/blog/articles/"+row.id+".html'>"+val+"</a>";
	} 
...
<div id="tb">
	...
	<div>
		<input type="text" style="position:relative;margin-left:5px;" placeholder="请输入要查询的标题..." id="s_title" size="21" onkeydown="if(event.keyCode==13) searchBlog()"/>
