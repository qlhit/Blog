...
<div class="data_list">
	  		<div class="data_list_title">
				<img src="${pageContext.request.contextPath}/static/images/list_icon.png"/><font color="white" size="4">最新博客</font>				
			</div>	  		
	  		<div class="datas">
	  			<ul>
	  				...
	  				<li style="margin-bottom: 30px">
					  	...
					  	<span id = "sourceId::${blog.id}" class = "cy_cmt_count" ></span>
							<script id="cy_cmt_num" src="http://changyan.sohu.com/upload/plugins/plugins.list.count.js?clientId=cysTxi2vT"></script>) </span>	  					
	  				</li>
